# Welcome to the canary-alpine contributing guide!
...
Please reference and adhere to our [pull request template](https://github.com/butlergroup/canary-alpine/blob/main/.github/PULL_REQUEST_TEMPLATE.md) when filing your pull request. 
...
After review, your pull request will either be approved (in which case congratulations on your contributions :tada::tada:! The canary-alpine team thanks you :sparkles:), or we'll consult with you about additional changes we believe are needed.
